...
under LGPL-2.1-or-later; enabling this feature does not relicense it as
...
| Disabled network namespace and socket filter | `NetworkMode::Disabled` | Removes direct IP access and rejects pathname-capable AF_UNIX datagram/seqpacket endpoints while preserving process-local stream and seqpacket socketpair IPC |
