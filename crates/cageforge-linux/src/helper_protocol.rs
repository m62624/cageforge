...
pub(crate) const NETWORK_MODE_DIRECT_WITH_UNIX: &str = "direct-with-unix";
pub(crate) const NETWORK_MODE_PROXY: &str = "proxy";
pub(crate) const NETWORK_MODE_PROXY_WITH_UNIX: &str = "proxy-with-unix";
...
pub(crate) const STATUS_MAGIC: &[u8] = b"CFSTATUS\x02";
pub(crate) const STATUS_RESULT_COMMAND: u8 = 0;
pub(crate) const STATUS_RESULT_FAILURE: u8 = 1;
pub(crate) const STATUS_RESULT_NO_ERRNO: i32 = i32::MIN;
...
pub(crate) const LOCAL_IPC_MAGIC: &[u8] = b"CFIPC\x01";
pub(crate) const LOCAL_IPC_DEFAULT_ALLOW: u8 = 0;
pub(crate) const LOCAL_IPC_DEFAULT_DENY: u8 = 1;
pub(crate) const LOCAL_IPC_TRACE_MARKER: u32 = 1;
pub(crate) const LOCAL_IPC_MAX_RULES: usize = 64;
pub(crate) const LOCAL_IPC_MAX_PATH_BYTES: usize = 4096;
